        ...
        <div class="card">
            <div class="card-header bg-red">
                    <ul class="nav nav-tabs card-header-tabs bg-red nav-fill" data-bs-toggle="tabs" role="tablist">
                        ...
                        <li class="nav-item text-black" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#acceptorrejectTicketsITPIC" aria-selected="false" role="tab">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#acceptedTicketsITPIC" aria-selected="false" role="tab" tabindex="-1">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#rejectedTicketITPIC" aria-selected="false" role="tab" tabindex="-1">
                                ...
                                Rejected Tickets to User
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" data-bs-toggle="tab" href="#rejectedSolutionByUser" aria-selected="false" role="tab" tabindex="-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-xbox-x">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path d="M12 21a9 9 0 0 0 9 -9a9 9 0 0 0 -9 -9a9 9 0 0 0 -9 9a9 9 0 0 0 9 9z" />
                                    <path d="M9 8l6 8" />
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane active show" id="myCreatedTicket" role="tabpanel">
                        ...
                        <asp:GridView ID="gvMyTicketList" runat="server" AutoGenerateColumns="false" CssClass="table table-hover card-table table-vcenter text-nowrap datatable mt-4" AllowPaging="true" PageSize="10" OnPageIndexChanged="gvMyTicketList_PageIndexChanged" EmptyDataTe="No Data Found">
                            <Columns>
                    ...
                    <div class="tab-pane fade" id="acceptorrejectTicketsITPIC" role="tabpanel">
                        ...
                        <asp:GridView ID="gvITPICAcceptOrRejectList" runat="server" AutoGenerateColumns="false" CssClass="table table-hover card-table table-vcenter text-nowrap datatable mt-4" AllowPaging="true" PageSize="10" OnPageIndexChanged="gvITPICAcceptOrRejectList_PageIndexChanged" EmptyDataTe="No Data Found">
                            <Columns>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade" id="acceptedTicketsITPIC" role="tabpanel">
                            ...
                            <asp:GridView ID="gvITPICAcceptedTickets" runat="server" AutoGenerateColumns="false" CssClass="table table-hover card-table table-vcenter text-nowrap datatable mt-4" AllowPaging="true" PageSize="10" OnPageIndexChanged="gvITPICAcceptedTickets_PageIndexChanged" EmptyDataTe="No Data Found">
                                <Columns>
                               <asp:BoundField DataField="ticket_code" HeaderText="Ticket Code" />
                        ...
                        <div class="tab-pane fade" id="rejectedTicketITPIC" role="tabpanel">
                            ...
                            <asp:GridView ID="gvITPICRejectedTickets" runat="server" AutoGenerateColumns="false" CssClass="table table-hover card-table table-vcenter text-nowrap datatable mt-4" AllowPaging="true" PageSize="10" OnPageIndexChanged="gvITPICRejectedTickets_PageIndexChanged" EmptyDataTe="No Data Found">
                                <Columns> 
                                    <asp:BoundField DataField="ticket_code" HeaderText="Ticket Code" />
                        ...
                        <div class="tab-pane fade" id="rejectedSolutionByUser" role="tabpanel">
                            ...
                            <asp:GridView ID="gvRejectedSolution" runat="server" AutoGenerateColumns="false" CssClass="table table-hover card-table table-vcenter text-nowrap datatable mt-4" AllowPaging="true" PageSize="10" OnPageIndexChanged="gvRejectedSolution_PageIndexChanged" EmptyDataTe="No Data Found">
                                <Columns>
                                   <asp:BoundField DataField="ticket_code" HeaderText="Ticket Code" />
                                   <asp:BoundField DataField="third_party_name" HeaderText="Third Party" />
                                   <asp:BoundField DataField="description_section" HeaderText="Section" />
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label status status-pink">Created By:</label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label status status-pink required-label">Subject:</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label status status-pink required-label">Description:</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label status status-pink required-label">Section</label>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label status status-pink required-label">Category</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label status status-pink required-label">Nature Of Problem</label>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 mt-2">
                            <label class="form-label status status-pink required-label">Others:</label>
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <div class="mb-2 mt-2">
                                    <asp:Label ID="Label8" runat="server" CssClass="form-label status status-pink">Attachment Description:</asp:Label>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3 mt-2">
                                <label class="form-label status status-pink required-label">Priority Level</label>
                            </div>
    ...
    <div class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true" id="mdITPICAcceptTicket3rdParty">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:Label ID="lblThirdPtName" runat="server" Text="Third Party Name" Placeholder="Insert 3rd Party Name" CssClass="form-label"></asp:Label>
                    <asp:TextBox ID="txt3rdPartyName" runat="server" CssClass="form-control text-area text-reset"></asp:TextBox>
                    <asp:Label ID="lblCalender3rdPt" runat="server" Text="Given Date" CssClass="form-label mt-2"></asp:Label>
                    <asp:TextBox ID="txtCalendarGivenTo" CssClass="form-control" TextMode="Date" placeholder="Select a date" runat="server"></asp:TextBox>

                    <div class="modal-footer">
                        <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
                        <asp:LinkButton ID="lnkAcceptThirdPartMd" runat="server" OnClick="lnkAcceptThirdPartMd_Click" CssClass="btn btn-success">Accept Ticket</asp:LinkButton>
                        <asp:LinkButton ID="lnkUpdateToThirdPartyMd" runat="server" OnClick="lnkUpdateToThirdPartyMd_Click" CssClass="btn btn-success">Update Tag to Third Party</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true" id="mdITPICRejectTicketRemarks">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
                    <asp:LinkButton ID="lnkMdITPICRejectTicketToAdmin" runat="server" OnClick="lnkMdITPICRejectTicketToAdmin_Click" CssClass="btn btn-danger">Reject Ticket</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
  ...
  <div class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true" id="mdITPICProposedSolution">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <asp:Label ID="lblRemarksProposed" runat="server" Text="Remarks" Placeholder="Input Remarks" CssClass="form-label"></asp:Label>
                    <asp:TextBox ID="txtRemarksProposedSolution" runat="server" TextMode="MultiLine" Rows="6" CssClass="form-control text-area text-reset"></asp:TextBox>
                    <asp:Label ID="lblAttachmentProposed" runat="server" Text="Remarks" CssClass="form-label"></asp:Label>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
...
<%--                                    <asp:LinkButton ID="lnkDeleteAttachment" OnClick="lnkDeleteAttachment_Click" runat="server"><i class="ti ti-pencil">Edit</i></asp:LinkButton>--%>
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:LinkButton ID="lnkSaveProposedSolution" runat="server" OnClick="lnkSaveProposedSolution_Click" CssClass="btn btn-success">Save Resolved</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
...
<%--                                    <asp:LinkButton ID="lnkDeleteAttachment" OnClick="lnkDeleteAttachment_Click" runat="server"><i class="ti ti-pencil">Edit</i></asp:LinkButton>--%>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn me-auto" data-bs-dismiss="modal">Close</button>
                        <%--<asp:LinkButton ID="lnkResolveAgain" runat="server" OnClick="lnkResolveAgain_Click" CssClass="btn btn-success">Save Resolved</asp:LinkButton>--%>
                        <asp:LinkButton ID="lnkSaveAsResolvedAgain" runat="server" OnClick="lnkSaveAsResolvedAgain_Click" CssClass="btn btn-success">Save as Resolved</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
